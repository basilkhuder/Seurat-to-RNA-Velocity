...
```
kb count -i transcriptome.idx -g t2g.txt -x 10xv2 --lamanno --loom -c1 cdna_t2c.txt -c2 intron_t2c.txt read_1.fastq.gz read_2.fastq.gz  
```
### Velocyto
#### Installation
...
``` r
%%R
write.csv(Cells(seurat_object), file = "cellID_obs.csv")
```
